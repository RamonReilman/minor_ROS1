...
- Some cell lines are plotted further away from the rest:
  - CUTO33 and CUTO 38. Where we also see that both treated and DMSO are comparable to eachother. Espcially CUTO 38, where we see near perfect clustering, even with treatment and DMSO.
- The other cell lines can be found clustered together. In some cases like CUTO23 and 28 there is a small, but notable, differences between treated and non treated cell lines.
